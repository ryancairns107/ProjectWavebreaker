...
namespace VRTK
{
    ...
    public class VRTK_InteractableObject : MonoBehaviour
    {
        ...
        [Tooltip("Will destroy the object after it is dropped (Default = Off)")]
        ...
        public virtual void Ungrabbed(VRTK_InteractGrab previousGrabbingObject = null)
        {
            ...
            Debug.Log("VRTK AUTOCODE NODESTROYONDROP");
            ...
            if (DestroyOnDrop)
            {
                ...
                GameObject Child1 = this.gameObject.transform.GetChild(2).gameObject;
                GameObject Child2 = this.gameObject.transform.GetChild(5).gameObject;
                Destroy(Child.GetComponent<BoxCollider>());
                Destroy(Child1.GetComponent<BoxCollider>());
                Destroy(Child2.GetComponent<BoxCollider>());
            }
